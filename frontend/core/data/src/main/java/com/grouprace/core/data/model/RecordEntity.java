...
public class RecordEntity {
    ...
    public RecordEntity(int recordId, String activityType, String title, String startTime, String endTime, int ownerId, int duration, float distance, float calories, float heartRate, float speed, String imageUrl, boolean pendingSync) {
