...
clubRouter.get('/:clubId/is-admin', validation(clubIdSchema, 'params'), clubController.checkIsAdmin);
...
clubRouter.get('/api/clubs/suggest', clubController.getSuggestedClubs);
// API: GET /api/clubs/search?search=john
clubRouter.get('/api/clubs/search', clubController.getClubsBySearch);

// Member management routes
clubRouter.get('/:clubId/members', validation(clubIdSchema, 'params'), clubController.getMembers);
clubRouter.put('/:clubId/members/:userId/status', 
    validation(memberIdSchema, 'params'), 
    validation(updateMemberStatusSchema), 
    clubController.updateMemberStatus
);
clubRouter.put('/:clubId/members/:userId/role', 
    validation(memberIdSchema, 'params'), 
